...
class ActivationTokenModel(TokenBaseModel):
    ...
    def __repr__(self) -> str:
        return f"<ActivationTokenModel(id={self.id}, token={self.token}, expires_at={self.expired_at})>"
...
class PasswordResetTokenModel(TokenBaseModel):
    ...
    def __repr__(self) -> str:
        return f"<PasswordResetTokenModel(id={self.id}, token={self.token}, expires_at={self.expired_at})>"
...
class RefreshTokenModel(TokenBaseModel):
    ...
    def __repr__(self) -> str:
        return f"<RefreshTokenModel(id={self.id}, token={self.token}, expires_at={self.expired_at})>"
